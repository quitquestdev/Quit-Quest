        ...
        <div className="bg-slate-800 border-4 border-slate-700 rounded-lg p-6 mb-4 backdrop-blur-lg bg-opacity-90">
          ...
          {setupStep === 1 && (
            <div className="animate-fade-in">
              <h2 className="text-2xl font-bold text-yellow-500 mb-4 pixelated">⚔️ HERO NAME</h2>
              <p className="text-gray-300 mb-4">What shall the bards call you, brave warrior?</p>
              <input
                type="text"
                value={setupForm.heroName}
                onChange={(e) => handleSetupChange('heroName', e.target.value)}
                placeholder="Enter your hero name..."
                className="w-full px-4 py-3 bg-slate-700 border-2 border-slate-600 rounded text-white placeholder-gray-500 focus:border-yellow-500 focus:outline-none pixelated"
              />
            </div>
          )}
          ...
          {setupStep === 2 && (
            <div className="animate-fade-in">
              ...
              <p className="text-gray-300 mb-4">When did you start this heroic quest?</p>
              <input
                type="date"
                value={setupForm.quitDate}
                onChange={(e) => handleSetupChange('quitDate', e.target.value)}
                className="w-full px-4 py-3 bg-slate-700 border-2 border-slate-600 rounded text-white focus:border-yellow-500 focus:outline-none pixelated"
              />
            </div>
          )}
          ...
          {setupStep === 3 && (
            <div className="animate-fade-in">
              ...
              <p className="text-gray-300 mb-4">How many cigarettes did you smoke per day?</p>
              <input
                type="number"
          ...
          {setupStep === 4 && (
            <div className="animate-fade-in">
              <h2 className="text-2xl font-bold text-yellow-500 mb-4 pixelated">💰 PACK PRICE</h2>
              <p className="text-gray-300 mb-4">How much did a pack cost? (in dollars)</p>
              <input
                type="number"
                step="0.01"
          ...
          {setupStep === 5 && (
            <div className="animate-fade-in">
              <h2 className="text-2xl font-bold text-yellow-500 mb-4 pixelated">🎭 CHOOSE CLASS</h2>
              <p className="text-gray-300 mb-4">Select your hero class:</p>
